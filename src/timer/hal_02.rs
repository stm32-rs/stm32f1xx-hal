...
use super::{
    Counter, CounterHz, Delay, ErasedChannel, Error, Instance, PwmChannel, SysCounter,
    SysCounterHz, SysDelay, TimC, WithPwm,
};
...
impl<TIM: Instance + WithPwm + TimC<C>, const C: u8, const COMP: bool> embedded_hal_02::PwmPin
